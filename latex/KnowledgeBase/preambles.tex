...
% \usepackage{newpxmath}  % matching Palatino math

\usepackage{amsmath, amsfonts, amssymb, xcolor, float, amsthm, mathtools, enumitem, cancel, soul, booktabs, multirow, array}
